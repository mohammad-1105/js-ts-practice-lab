...
import {
  ...
  isValidParcelWeight,
  isWholeNumber,
} from "../src/10-zipcode-checker.ts";

describe("10 - Zipcode Type Checker: Type Checking (9 pts)", () => {
  describe("getDataType", () => {
    ...
    test('returns "null" for null', () => {
      expect(getDataType(null as any)).toBe("null");
    });

    test('returns "undefined" for undefined', () => {
      expect(getDataType(undefined as any)).toBe("undefined");
    });
  ...
  describe("isValidParcelWeight", () => {
    ...
    test("returns false for null/undefined", () => {
      expect(isValidParcelWeight(null as any)).toBe(false);
      expect(isValidParcelWeight(undefined as any)).toBe(false);
    });
  });
  ...
  describe("isNotANumber", () => {
    ...
    test("returns false for undefined", () => {
      expect(isNotANumber(undefined as any)).toBe(false);
    });

    test("returns false for null", () => {
      expect(isNotANumber(null as any)).toBe(false);
    });
  });
  ...
  describe("isTruthy", () => {
    ...
    test("returns false for falsy values", () => {
      ...
      expect(isTruthy(null as any)).toBe(false);
      expect(isTruthy(undefined as any)).toBe(false);
